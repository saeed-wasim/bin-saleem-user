  ...
  <div class="container mx-auto p-3 sm:p-6">
    ...
    <div class="text-center mb-8 sm:mb-10">
      ...
      <p class="text-sm text-gray-500 mt-2 max-w-md mx-auto">
        Find meaningful gifts designed to make every celebration unforgettable.
      </p>
    </div>
    <div v-if="loading" class="text-gray-500">Loading gift guide...</div>
    ...
    >
      No gift guide picks yet — check back soon.
    </div>
